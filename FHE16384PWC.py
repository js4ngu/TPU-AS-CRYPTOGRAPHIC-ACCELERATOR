...
def main():
    ...
    coefBit = (24, 24)
    peSize = 64
    rns_ch_list = '/home/jongsang/File/tpu-as-crypto/TPU-AS-CRYPTOGRAPHIC-ACCELERATOR/prothPrime/FHE/rns14.json'  # JSON 파일 경로를 여기에 삽입하세요.
    ...
    parameterDir = "/home/jongsang/File/tpu-as-crypto/TPU-AS-CRYPTOGRAPHIC-ACCELERATOR/parameter/PWC/FHE/14/"
